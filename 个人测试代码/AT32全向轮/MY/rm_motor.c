...
#include<chassis.h>//为了使用PUSH_MOTOR这个结构体
#include<pid.h>

extern struct PID pids1,pidp1,pids2,pidp2,pids3,pidp3,pids4,pidp4,pid5,pid6,pid7,pid8;
...
void Rm_Motor_posManeger(struct PUSH_MOTOR *PushMotor)
{
	int U1=0,U2=0,U3=0,U4=0;
	
	
	U1=Pid_PlaceSerialSpeed(&pidp1, PushMotor[0].Aim_Place+*PushMotor[0].Zero_Place,
	*PushMotor[0].Now_Place,&pids1,PushMotor[0].Aim_Speed,*PushMotor[0].Now_Speed,PushMotor[0].Max_Current,10000);
	
	U2=Pid_PlaceSerialSpeed(&pidp2, PushMotor[1].Aim_Place+*PushMotor[1].Zero_Place,
	*PushMotor[1].Now_Place,&pids2,PushMotor[1].Aim_Speed,*PushMotor[1].Now_Speed,PushMotor[1].Max_Current,10000);
	
	U3=Pid_PlaceSerialSpeed(&pidp3, PushMotor[2].Aim_Place+*PushMotor[2].Zero_Place,
	*PushMotor[2].Now_Place,&pids3,PushMotor[2].Aim_Speed,*PushMotor[2].Now_Speed,PushMotor[2].Max_Current,10000);
	
	U4=Pid_PlaceSerialSpeed(&pidp4, PushMotor[3].Aim_Place+*PushMotor[3].Zero_Place,
	*PushMotor[3].Now_Place,&pids4,PushMotor[3].Aim_Speed,*PushMotor[3].Now_Speed,PushMotor[3].Max_Current,10000);
	
	RM_Tx(0x200,2,U1,U2,U3,U4);
	
}

void Rm_Motor_velManeger(struct PUSH_MOTOR *PushMotor)
{
	int U5=0,U6=0,U7=0,U8=0;
	
		U5=pid_speed_current(&pid5,PushMotor[4].Aim_Speed,*PushMotor[4].Now_Speed,1000);
        U6=pid_speed_current(&pid6,PushMotor[5].Aim_Speed,*PushMotor[5].Now_Speed,1000);
		U7=pid_speed_current(&pid7,PushMotor[6].Aim_Speed,*PushMotor[6].Now_Speed,1000);
		U8=pid_speed_current(&pid8,PushMotor[7].Aim_Speed,*PushMotor[7].Now_Speed,1000);
