...
//	OLED_Init();
	...
	//s型速度曲线
	CurveObject_Init(&s_curve[0],0,0, 50,-2000,2000,1.0);
	CurveObject_Init(&s_curve[1],0,0, 50,-2000,2000,1.0);
	CurveObject_Init(&s_curve[2],0,0, 50,-2000,2000,1.0);
	CurveObject_Init(&s_curve[3],0,0, 50,-2000,2000,1.0);
...
//		Serial_Printf("%d,%d\r\n",Motor[0].real_speed,Motor[0].target_speed);
