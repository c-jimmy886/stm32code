...
{(TaskFunction_t)Hand_Task,&Hand_Task_Handler,256,1,"Hand_Task",NULL},
{(TaskFunction_t)Control_Task,&Control_Task_Handler,256,1,"Control_Task",NULL},
};
